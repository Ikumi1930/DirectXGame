...
void  DirectXCommon::Initialization(WinApi* win, const wchar_t* title, int32_t backBufferWidth, int32_t backBufferHeight)
{
	winApi_ = win;
...
void DirectXCommon::CreateSwapChain()
{
	...
	swapChainDesc.Width = WinApi::kClientWidth;//画面の幅
	swapChainDesc.Height = WinApi::kClientHeight;//画面の高さ
	...
	hr_ = dxgiFactory_->CreateSwapChainForHwnd(commandQueue_, winApi_->GetHwnd(), &swapChainDesc, nullptr, nullptr, reinterpret_cast<IDXGISwapChain1**>(&swapChain_));
	assert(SUCCEEDED(hr_));
